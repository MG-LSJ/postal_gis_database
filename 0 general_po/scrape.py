...
baseurl = "https://webgis.nic.in/publishing/rest/services/misc/post/MapServer/0/query?token=LFFsVAR6Zo17lk12KOYg6216EquuOdsywx2LbAGfPkD7MI6N2p25JhH3XQJ3aUizvQW9EJ5TNhgAVvlaZITRFA..&f=json&where=&returnGeometry=true&spatialRel=esriSpatialRelIntersects&outFields=*&objectIds="
minId = 1
maxId = 23
...
with open("general_po.geojson", "w") as f:
